...
Compile and Run
---
1. In testsrc folder, run XMLFormaterTest as JUnit test which has test case 1, 2 and other test cases whose method names are self- explaining. It generates CSV output files in “testOutput” directory. 
2. 1. In testsrc folder, run CSVFormaterTest as JUnit test has test case 3 and other test cases whose method names are self- explaining. It generates XML output files in “testOutput” directory. 
